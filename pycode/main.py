...
class FtxClient:
    ...
    def __init__(self, api_key=None, api_secret=None, subaccount_name=None) -> None:
        ...
        self._api_key = 'gpX-tLJ0WUWYt7I2TYGYmip_nl2W972q8goXMs9R'
        self._api_secret = 'x5xUb3U3-OMBkrowb-i8bBaaLEPxuEVyOczb6hLx'
...
while(True) :
    ...
    response = requests.post(requesturl,data = atdic)
    responee =requests.post(requesturl,data = soldic)
    time.sleep(30)
